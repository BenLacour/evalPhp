...
<body>
    ...
    <table class="table">
        ...
        // Faire apparaitre les voitures de la bd sous forme de tableau

        // Requête SQL pour selectionner les véhicules

        $sql = "SELECT * FROM logement";
        $resultat = $bdd->query($sql);

        // Faire apparaitre les infos des véhicules dans chaque ligne
